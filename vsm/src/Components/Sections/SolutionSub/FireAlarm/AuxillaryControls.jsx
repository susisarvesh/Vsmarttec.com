      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 auto-rows-auto">
        ...
        <div className="grid-item col-span-1 sm:col-span-2 lg:col-span-2 xl:col-span-2 bg-white rounded-lg shadow-2xl p-6 flex flex-col items-start min-h-full">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-normal text-customBlue mb-4">
            Optimizing Systems with Vsmart's Auxiliary Equipment Controls
          </h3>
          ...
          <div className="text-gray-700 p-1 text-sm sm:text-base lg:text-lg leading-relaxed mb-2 lg:p-4">
            <p>
              Vsmart’s auxiliary equipment controls are designed to manage and optimize devices that complement your primary systems. Whether it's regulating settings, initiating processes, or handling peripheral equipment like backup generators, HVAC systems, or lighting, our solutions provide seamless integration.
            </p>
            <p className="mt-4 hidden lg:block">
              By enhancing the functionality and reliability of supplementary devices, Vsmart’s controls improve the efficiency and effectiveness of your entire system, ensuring smooth operations across various equipment and contributing to better overall system performance.
            </p>
          </div>
        </div>
        ...
        <div className="grid-item col-span-1 sm:col-span-2 lg:grid-cols-2 xl:grid-cols-2 p-1 rounded-lg overflow-hidden">
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 md:grid-cols-2">
            <div className="bg-gray-300 rounded-lg overflow-hidden">
              <img
                src="https://www.example.com/auxillary1.jpg"
                alt="Auxiliary Control 1"
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-gray-300 rounded-lg overflow-hidden">
                <img
                  src="https://www.example.com/auxillary2.jpg"
                  alt="Auxiliary Control 2"
                  className="w-full h-full object-cover"
                />
              </div>
              <div className="bg-gray-300 rounded-lg overflow-hidden">
                <img
                  src="https://www.example.com/auxillary3.jpg"
                  alt="Auxiliary Control 3"
                  className="w-full h-full object-cover"
                />
              </div>
            </div>
...
export default AuxillaryControls;
