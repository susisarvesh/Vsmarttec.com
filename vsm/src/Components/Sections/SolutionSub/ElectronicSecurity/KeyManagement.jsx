      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 auto-rows-auto">
        ...
        <div className="grid-item col-span-1 sm:col-span-2 lg:col-span-2 xl:col-span-2 bg-white rounded-lg shadow-2xl p-6 flex flex-col items-start min-h-full">
          ...
          <div className="text-gray-700 p-1 text-sm sm:text-base lg:text-lg leading-relaxed mb-2 lg:p-4">
            <p>
              Vsmart’s key management solutions are designed to securely manage, track, and control access to physical keys. Featuring key cabinets or lockers with electronic controls, our systems track key usage through detailed logs and audits, ensuring secure and efficient management of keys.
            </p>
            <p className="mt-4 hidden lg:block">
              Users must authenticate themselves to retrieve or return keys, ensuring that only authorized personnel have access. Advanced features include integration with access control systems, real-time monitoring, reporting, and alerts, all of which enhance security and streamline key handling processes.
            </p>
          </div>
        </div>
