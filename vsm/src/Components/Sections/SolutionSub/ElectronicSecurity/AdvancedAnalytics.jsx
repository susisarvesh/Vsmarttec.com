      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 auto-rows-auto">
        ...
        <div className="grid-item col-span-1 sm:col-span-2 lg:col-span-2 xl:col-span-2 bg-white rounded-lg shadow-2xl p-6 flex flex-col items-start min-h-full">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-normal text-customBlue mb-4">
            Enhancing Security with Vsmart’s Advanced Analytics Solutions
          </h3>
          ...
          <div className="text-gray-700 p-1 text-sm sm:text-base lg:text-lg leading-relaxed mb-2 lg:p-4">
            <p>
              Vsmart’s advanced analytics and intelligence solutions enhance video surveillance by incorporating sophisticated algorithms and artificial intelligence. Our systems offer real-time object detection, facial recognition, automatic number plate recognition (ANPR), and behavior analysis, providing deeper insights into security data.
            </p>
            <p className="mt-4 hidden lg:block">
              By identifying and alerting on unusual activities, tracking specific individuals, and analyzing patterns across multiple cameras, Vsmart’s solutions improve security by offering actionable insights, reducing false alarms, and enabling proactive threat responses.
            </p>
          </div>
        </div>
