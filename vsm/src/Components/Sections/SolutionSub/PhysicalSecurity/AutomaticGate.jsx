      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 auto-rows-auto">
        ...
        <div className="grid-item col-span-1 sm:col-span-2 lg:col-span-2 xl:col-span-2 bg-white rounded-lg shadow-2xl p-6 flex flex-col items-start min-h-full">
          <h3 className="text-xl sm:text-2xl lg:text-3xl font-normal text-customBlue mb-4">
            Vsmart's Automatic Gate and Parking Solutions for Enhanced Access Control
          </h3>
          ...
          <div className="text-gray-700 p-1 text-sm sm:text-base lg:text-lg leading-relaxed mb-2 lg:p-4">
            <p>
              Vsmart provides automatic gate and parking solutions that streamline vehicle access and control. Our motorized gates operate based on user credentials, such as remote controls, key cards, or license plate recognition, offering secure and convenient entry to properties.
            </p>
            <p className="mt-4 hidden lg:block">
              Our parking solutions include automated systems for vehicle entry and exit, featuring ticket dispensers, barrier arms, and pay stations, often integrated with smart technologies for real-time monitoring and efficient space utilization. These solutions enhance security, improve traffic flow, and simplify access management.
            </p>
          </div>
        </div>
